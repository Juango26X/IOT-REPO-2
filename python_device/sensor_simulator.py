...
def generate_sensor_data():
    ...
    if SENSOR_TYPE == "temperature":
        value = round(random.uniform(20.0, 40.0), 2)  # rango ampliado para cruzar umbral de alerta
    elif SENSOR_TYPE == "humidity":
        value = round(random.uniform(40.0, 60.0), 2)
    elif SENSOR_TYPE == "oxygen":
        # Nivel de oxígeno en porcentaje (rango típico: 19.5% – 23.5%)
        value = round(random.uniform(19.5, 23.5), 2)
    else:
